...
export const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
      <GlobalHeader currentPage="contact" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-700 text-lg max-w-2xl mx-auto">
              نحن سعداء لتواصلك معنا! سواء كان لديك استفسار عن غسان أو اقتراح لتطوير المشروع
            </p>
          </div>
              ...
              <Card className="shadow-xl bg-white/90 backdrop-blur-sm border-white/50">
                ...
                <CardContent className="text-right space-y-3">
                  <p className="text-gray-700 leading-relaxed">
                    غسان هو مشروع المبادرة القرائية لمدرسة غسان بن عبدالله الخروصي (١٠-١٢) فكرته تقوم على أن يكون المساعد الأدبي الذكي المصمم خصيصاً لخدمة الطلاب والباحثين والمهتمين بالأدب العُماني، ليجمع بين الذكاء الاصطناعي المتقدم والمعرفة المتخصصة في الأدب والثقافة العُمانية.
                  </p>
